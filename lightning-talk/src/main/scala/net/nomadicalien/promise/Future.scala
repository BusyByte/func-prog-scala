package net.nomadicalien.promise
...
object Future {
  ...
  private[promise] val toBoxed = Map[Class[_], Class[_]](
  ...
  // a side effect.
  private[promise] object InternalCallbackExecutor extends ExecutionContext with BatchingExecutor {
